...
"""
def prepare_indri_query_top_k_features(features, weights, query_number, topk, window_size, prf=False):
    ...
    for tuple in sorted_by_second[0:topk]:
        ...
        if feature_string:
            ...
            weight = tuple[1]
            weight = 1
            st += str(weight) + " #" + str(window_size) + "(" + feature_string_final + ") "
...
def main():
    ...
    for idx, file in enumerate(onlyfiles[:number_of_files]):
        ...
        for window_size in window_sizes:
            ...
            query = prepare_indri_query_top_k_features(features, weights, query_number, window_size=window_size, topk=number_of_query_terms, prf=False)
